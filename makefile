...
ifeq ($(filter $(PLATFORM),tg5040 my355),$(PLATFORM))
...
package: tidy
	...
	cd ./build/BASE && zip -r ../../releases/$(RELEASE_NAME)-base.zip Bios Roms Saves Shaders trimui miyoo355 em_ui.sh MinUI.zip README.txt
